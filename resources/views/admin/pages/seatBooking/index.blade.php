    ...
    <div class="card">
        <div class="card-header">
            {{-- <div class="d-flex justify-content-end">
                @can('seats-create')
                    <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#addNewModalId">Add New Booking</button>
                @endcan
            </div> --}}
        </div>
        <div class="card-body">
            <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                ...
                @foreach($bookings as $key => $booking)
                    <tr>
                        ...
                        <td>
                            <div class="d-flex ">
                                ...
                                @endcan --}}
                                @can('seats-delete')
                                    <a href="{{ route('seat_booking.destroy', $booking->id) }}" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal{{$booking->id}}">Delete</a>
                                @endcan
                            </div>
                        </td>
                    </tr>
                    ...
                    <!-- Delete Modal -->
                    <div id="deleteModal{{$booking->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel{{$booking->id}}" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header modal-colored-header bg-danger">
                                    <h4 class="modal-title" id="deleteModalLabel{{$booking->id}}">Delete Booking</h4>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="{{ route('seat_booking.destroy', $booking->id) }}" class="btn btn-danger">Delete</a>
                                </div>
                            </div>
                        </div>
                    </div>
