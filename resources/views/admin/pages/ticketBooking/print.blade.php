                    ...
                    <div class="ticket">
                        <div class="header"
                            ...
                            <div class="d-flex align-items-center"
                                style="display: table; box-sizing:border-box; width: 500px;">
                                <div class="company-logo"
                                    style="display: table-cell; width: 100px; height:50px; margin-right: 10px; vertical-align: middle;">
                                    ...
                                    <img src="{{ public_path($companyLogo) }}" alt="logo"
                                        style=" width: 100px; height:50px; margin-right: 10px; object-fit: contain;">
                                </div>

                                <h1 class="text-nowrap operator text-uppercase"
                                    style="display: table-cell; width:400px; white-space: nowrap; margin: 0; font-size: 24px; vertical-align: middle;">
                                    {{ $vehicle->name }}
                                </h1>
                            </div>
                            ...
                            <h1 class="text-nowrap passenger text-uppercase p-3"
                                style="display: table-cell; box-sizing:border-box; white-space: nowrap; width: 300px; margin: 0; font-size: 20px; padding-left: 16px; vertical-align: middle;">
                                Passenger Info</h1>
                        </div>
                            ...
                            <div class="right passenger ps-3"
                                ...
                                <div class="details" style="font-size: 14px; margin-top: 10px;">
                                    ...
                                    <div class="py-1" style="padding: 5px 0;"><strong>Price:</strong>
                                        {{ number_format($seatsData[0]['seatPrice'], 2) }} BDT X
                                        {{ count($seatsData) }} </div>
