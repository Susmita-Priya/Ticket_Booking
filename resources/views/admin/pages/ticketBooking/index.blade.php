                                ...
                                <div class="seat-wrapper">
                                    ...
                                    @elseif($vehicle_category == 2)
                                        ...
                                        <ul class="nav nav-pills border nav-justified mb-4" id="pills-tab"
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active" id="pills-lower-tab" data-toggle="pill"
                                                    data-target="#pills-lower" type="button" role="tab"
                                                    aria-controls="pills-lower" aria-selected="true">Lower</button>
                                            </li>
                                            <!--   single tab     -->
                                            <li class="nav-item" role="presentation">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="d-flex justify-content-between mt-2">
                                            ...
                                            <button class="btn btn-primary w-50" id="reserve-button-{{ $trip->id }}"
                                    ...
                                    <div class="mb-3" id="card-id-field" style="display: none;">
                                        <div class="mb-3">
                                            <label for="card-id" class="form-label">Card Number<span
                                                    style="color: red;">*</span></label>
                                            <input type="text" id="card-id" name="card_number" class="form-control"
                                                placeholder="XXXX XXXX XXXX XXXX">
                                        </div>
                                        <div class="mb-3">
                                            <label for="expirationdate" class="form-label">Expiration (mm/yy)<span
                                                    style="color: red;">*</span></label>
                                        ...
                                        <div class="mb-3">
                                            <label for="securitycode" class="form-label">Security Code<span
                                                    style="color: red;">*</span></label>
                                            <input id="securitycode" type="text" pattern="[0-9]*" name=security_code
                                                inputmode="numeric" class="form-control" placeholder="XXX">
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title">Total Price : ৳ <span id="total-price-modal">0.00</span>
                                        </h4>
