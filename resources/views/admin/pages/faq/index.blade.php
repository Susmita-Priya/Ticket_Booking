                ...
                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    @foreach($faq as $key=>$faqData)
                        <tr>
                            <td>{{++$key}}</td>
                            <td>{{$faqData->title}}</td>
                            <td>{!! Str::limit($faqData->details, 30) !!}</td>
                                            ...
                                            <form method="post" action="{{route('faq.update',$faqData->id)}}" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="title" name="title" value="{{$faqData->title}}"
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="mb-3">
                                                            <label> Details</label>
                                                            <textarea class="form-control" name="details" rows="5" placeholder="Enter the Description">{{ strip_tags($faqData->details) }}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="mb-3">
